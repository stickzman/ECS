export default class InputSystem {
    constructor(ecs) {
        this.ecs = ecs
        this.ecs.registerGlobal("inputActions", {})
        this.ecs.registerGlobal("input", new InputState())
        this.ecs.registerGlobal("inputStream", new InputStream())
        this.ecs.registerGlobal("bindings", new KeyBindings())
    ...
    init(ecs) {
        ...
        window.addEventListener("keydown", e => {
            let action = ecs.bindings.getAction(e.key.toLowerCase())
    ...
    addKeyBindings(bindings) {
        ...
        for (const action in bindings) {
            ...
            this.ecs.bindings.addBinding(action, key)
        }
    }
}
